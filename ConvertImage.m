...
% It does this using by using the k-means algorithm, an algorithm
% which can be used to sort data into k clusters.
% Before this script can be used the following functions must be
% 
% Author: Jack Chamberlain

% Read in an image to convert
% If enter is hit the image to read will default to test.jpg
